...
export class MypersonalworksComponent {
  ...
  cards = [
    { title: 'Mars Food Services', content: 'Explore the Mars Foodservices family of brands',url:"https://www.marsfoodservices.com/",logo:"assets/mars.png" },
    ...
    { title: 'Welovepets', content: 'Good inward & Outward',url:"assets/welovepets.pdf",logo:"assets/welovepets.png" },
